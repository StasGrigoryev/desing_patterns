package org.example.patterns.creational.builder.cars;
...
/*
    Car manual is the second product. Note that the manual and the car does not
    have a common interface. They are independent from each other.
 */
public class Manual {
